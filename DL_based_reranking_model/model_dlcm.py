...
class DLCM(object):
    ...
    def __init__(self, input_format):
        ...
        self.single_cell = tf.contrib.rnn.GRUCell(self.params['dims'] + self.params['dims'])
        ...
        self.encoder_outputs, self.encoder_state = tf.nn.static_rnn(self.single_cell, self.rank_join_in, dtype=tf.float32)

        self.rank_join_gru = tf.concat(self.encoder_outputs, self.encoder_state)

        # predicting layer
        self.deep_out = self.rank_join_gru
